...
#  Fetch Snowflake connection parameters from Secret Manager
...
def handle_request():
    ...
    if request.method == "GET":
        ...
        return jsonify({"message": "Service is running.", "current_datetime": current_datetime}), 200
    ...
    # Handle POST requests
        ...
        try:
            ...
            table_name = "electric_vehicle_data"
